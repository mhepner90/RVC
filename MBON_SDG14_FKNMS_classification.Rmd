...
sc_maxrich      = read.csv("C:/Users/luke.mceachron/Documents/Git/RVC/OtherGroups/CREMP_MaxRichness.csv")
sc_pcover       = read.csv("C:/Users/luke.mceachron/Documents/Git/RVC/OtherGroups/CREMP_Pcover_group.csv")
...
names(sc_pcov_spp)
  ...
  #diversity
y96=sc_pcov_spp[which(sc_pcov_spp$Year==1996),]
y96=y96[-c(1)]
...
#Richness
S1=specnumber(y96); S1

#calculate shannon diversity, favors all species equally(q=1), assumes all species are represented and a random sample

H1=diversity(y96,index="shannon")
HE1=exp(diversity(y96,index="shannon"))

#calculate simpson diversity, favors more common species (q=2)

D1=diversity(y96,index="simpson"); D1

#convert simpson to effective number
DE1=1/(1-D1); DE1
