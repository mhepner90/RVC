...
forage_fk_diversity_csv = "big_csv/trophic_groups/diveristy/forage_fk_diversity.csv"

if(!all(file.exists(forage_fk_abun_csv,forage_dt_abun_csv,forage_fk_den_csv,forage_dt_den_csv, forage_fk_diversity_csv)){
