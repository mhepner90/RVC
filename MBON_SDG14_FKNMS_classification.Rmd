...
rvc94 <-read.csv("90srvc/fk1994_dat2.csv") #don't have 1994 

abundance: Estimated abundance per sampling domain

rvc95_16 <- rbind(RVCdata_FK$sample_data, rvc98, rvc97, rvc96, rvc95) #,rvc94

#STRAT
strat94<-read.csv("FKeys_NTOTS_Reweight_1994.csv")#need csv file from luke 
