...
#density 
exploited_fk_bio <- getDomainBiomass(RVCdata_FK, species = exploited_spp_list, RVCdata_FK$taxonomic_data, merge_protected = F)
write_csv(exploited_fk_bio,"big_csv/exploited/exploited_fk_bio.csv")
}
