...
d = data_frame()
for (f in list.files('/Users/debbiehepner/Dropbox/github/RVC/abundance_domain', pattern="\\.csv", full.names=T)){
      cat(' ', f,'\n')
      d_f = read_csv(
        f, #path to a file 
...
write_csv(d, 'domain_abun_1999_2016.csv')
...
cat("bind all csv's\n") #concatenate and print - character string naming the file to print to
  d = data_frame()
    for (f in list.files('/Users/debbiehepner/Dropbox/github/RVC/abundance_strata', pattern="*.csv", full.names=T)){
      cat(' ', f,'\n')
      d_f = read_csv(
        f, #path to a file 
        progress=F, #progress: Display a progress bar
        ...
        col_types = cols(
          protected_status = col_character()))  #column specification - must contain one column specification for each column
      strata_abun_1999_2016 = bind_rows(d, d_f)
write_csv(strata_abun_1999_2016, 'abundance_strata/strata_abun_1999_2016.csv')     
    } 
...
cat("bind all csv's\n") #concatenate and print - character string naming the file to print to
  d = data_frame()
    for (f in list.files('/Users/debbiehepner/Dropbox/github/RVC/abundance_psu', pattern="*.csv", full.names=T)){
      cat(' ', f,'\n')
      d_f = read_csv(
        f, #path to a file 
        progress=F, #progress: Display a progress bar
        ...
        col_types = cols(
          protected_status = col_character()))  #column specification - must contain one column specification for each column
      psu_abun_1999_2016 = bind_rows(d, d_f)
write_csv(psu_abun_1999_2016, 'abundance_psu/psu_abun_1999_2016.csv')     
    } 
```
