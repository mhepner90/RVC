...
write_csv(biofk2000, 'big_csv/biomass_domain/FK/biofk2000.csv') #2000 
...
write_csv(biofk2001, 'big_csv/biomass_domain/FK/biofk2001.csv') #2001 
...
write_csv(biofk2002, 'big_csv/biomass_domain/FK/biofk2002.csv') #2002
...
write_csv(biofk2003, 'big_csv/biomass_domain/FK/biofk2003.csv') #2003
...
write_csv(biofk2004, 'big_csv/biomass_domain/FK/biofk2004.csv') #2004
...
write_csv(biofk2005, 'big_csv/biomass_domain/FK/biofk2005.csv') #2005
...
write_csv(biofk2006, 'big_csv/biomass_domain/FK/biofk2006.csv') #2006
...
write_csv(biofk2007, 'big_csv/biomass_domain/FK/biofk2007.csv') #2007
...
write_csv(biofk2008, 'big_csv/biomass_domain/FK/biofk2008.csv') #2008
...
write_csv(biofk2009, 'big_csv/biomass_domain/FK/biofk2009.csv') #2009
...
write_csv(biofk2010, 'big_csv/biomass_domain/FK/biofk2010.csv') #2010
...
write_csv(biofk2011, 'big_csv/biomass_domain/FK/biofk2011.csv') #2011
...
write_csv(biofk2012, 'big_csv/biomass_domain/FK/biofk2012.csv') #2012
...
write_csv(biofk2014, 'big_csv/biomass_domain/FK/biofk2014.csv') #2014
...
write_csv(biofk2016, 'big_csv/biomass_domain/FK/biofk2016.csv') #2016
...
write_csv(biodt1999, 'big_csv/biomass_domain/DT/biodt1999.csv') #1999
...
write_csv(biodt2000, 'big_csv/biomass_domain/DT/biodt2000.csv') #2000
...
write_csv(biodt2004, 'big_csv/biomass_domain/DT/biodt2004.csv') #2004
...
write_csv(biodt2006, 'big_csv/biomass_domain/DT/biodt2006.csv') #2006
...
write_csv(biodt2008, 'big_csv/biomass_domain/DT/biodt2008.csv') #2008
...
write_csv(biodt2010, 'big_csv/biomass_domain/DT/biodt2010.csv') #2010
...
write_csv(biodt2012, 'big_csv/biomass_domain/DT/biodt2012.csv') #2012
...
write_csv(biodt2014, 'big_csv/biomass_domain/DT/biodt2014.csv') #2014
...
write_csv(biodt2016, 'big_csv/biomass_domain/DT/biodt2016.csv') #2016
...
cat("bind all csv's\n") #concatenate and print - character string naming the file to print to
d_fk = data_frame()
for (f in list.files('big_csv/biomass_domain/FK', pattern="\\.csv", full.names=T)){
      cat(' ', f,'\n')
      d_f = read_csv(
        f, #path to a file 
        progress=F, #progress: Display a progress bar
...
write_csv(d_fk, 'big_csv/biomass_domain/domain_fk_biomass.csv')


## DT biomass by domain 
cat("bind all csv's\n") #concatenate and print - character string naming the file to print to
d_dt = data_frame()
for (f in list.files('big_csv/biomass_domain/DT', pattern="\\.csv", full.names=T)){
      cat(' ', f,'\n')
      d_f_dt = read_csv(
        f, #path to a file 
        progress=F, #progress: Display a progress bar
...
write_csv(d_dt, 'big_csv/biomass_domain/domain_dt_biomass.csv')
...
write_csv(strata_biofk1999, 'big_csv/biomass_strata/FK/strata_biofk1999.csv') #1999
)
...
write_csv(strata_biofk2000, 'big_csv/biomass_strata/FK/strata_biofk2000.csv') #2000
)
...
write_csv(strata_biofk2001, 'big_csv/biomass_strata/FK/strata_biofk2001.csv') #2001
)
...
write_csv(strata_biofk2002, 'big_csv/biomass_strata/FK/strata_biofk2002.csv') #2002
)
...
write_csv(strata_biofk2003, 'big_csv/biomass_strata/FK/strata_biofk2003.csv') #2003
)
...
write_csv(strata_biofk2004, 'big_csv/biomass_strata/FK/strata_biofk2004.csv') #2004
)
...
write_csv(strata_biofk2005, 'big_csv/biomass_strata/FK/strata_biofk2005.csv') #2005
)
...
write_csv(strata_biofk2006, 'big_csv/biomass_strata/FK/strata_biofk2006.csv') #2006
)
...
write_csv(strata_biofk2007, 'big_csv/biomass_strata/FK/strata_biofk2007.csv') #2007
)
...
write_csv(strata_biofk2008, 'big_csv/biomass_strata/FK/strata_biofk2008.csv') #2008
)
...
write_csv(strata_biofk2009, 'big_csv/biomass_strata/FK/strata_biofk2009.csv') #2009
)
...
write_csv(strata_biofk2010, 'big_csv/biomass_strata/FK/strata_biofk2010.csv') #2010
)
...
write_csv(strata_biofk2011, 'big_csv/biomass_strata/FK/strata_biofk2011.csv') #2011
)
...
write_csv(strata_biofk2012, 'big_csv/biomass_strata/FK/strata_biofk2012.csv') #2012
)
...
write_csv(strata_biofk2014, 'big_csv/biomass_strata/FK/strata_biofk2014.csv') #2014
)
...
write_csv(strata_biofk2016, 'big_csv/biomass_strata/FK/strata_biofk2016.csv') #2016
)

dt1999<- getRvcData(1999, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
strata_biodt1999 <- getStratumBiomass(dt1999, species = dt1999$taxonomic_data$SPECIES_CD, growth_parameters = dt1999$taxonomic_data, merge_protected = F)  
write_csv(strata_biodt1999, 'big_csv/biomass_strata/DT/strata_biodt1999.csv') #1999

dt2000<- getRvcData(2000, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
strata_biodt2000 <- getStratumBiomass(dt2000, species = dt2000$taxonomic_data$SPECIES_CD, growth_parameters = dt2000$taxonomic_data, merge_protected = F)  
write_csv(strata_biodt2000, 'big_csv/biomass_strata/DT/strata_biodt2000.csv') #2000

dt2004<- getRvcData(2004, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
strata_biodt2004 <- getStratumBiomass(dt2004, species = dt2004$taxonomic_data$SPECIES_CD, growth_parameters = dt2004$taxonomic_data, merge_protected = F)  
write_csv(strata_biodt2004, 'big_csv/biomass_strata/DT/strata_biodt2004.csv') #2004

dt2006<- getRvcData(2006, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
strata_biodt2006 <- getStratumBiomass(dt2006, species = dt2006$taxonomic_data$SPECIES_CD, growth_parameters = dt2006$taxonomic_data, merge_protected = F)  
write_csv(strata_biodt2006, 'big_csv/biomass_strata/DT/strata_biodt2006.csv') #2006

dt2008<- getRvcData(2008, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
strata_biodt2008 <- getStratumBiomass(dt2008, species = dt2008$taxonomic_data$SPECIES_CD, growth_parameters = dt2008$taxonomic_data, merge_protected = F)  
write_csv(strata_biodt2008, 'big_csv/biomass_strata/DT/strata_biodt2008.csv') #2008

dt2010<- getRvcData(2010, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
strata_biodt2010 <- getStratumBiomass(dt2010, species = dt2010$taxonomic_data$SPECIES_CD, growth_parameters = dt2010$taxonomic_data, merge_protected = F)  
write_csv(strata_biodt2010, 'big_csv/biomass_strata/DT/strata_biodt2010.csv') #2010

dt2012<- getRvcData(2012, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
strata_biodt2012 <- getStratumBiomass(dt2012, species = dt2012$taxonomic_data$SPECIES_CD, growth_parameters = dt2012$taxonomic_data, merge_protected = F)  
write_csv(strata_biodt2012, 'big_csv/biomass_strata/DT/strata_biodt2012.csv') #2012

dt2014<- getRvcData(2014, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
strata_biodt2014 <- getStratumBiomass(dt2014, species = dt2014$taxonomic_data$SPECIES_CD, growth_parameters = dt2014$taxonomic_data, merge_protected = F)  
write_csv(strata_biodt2014, 'big_csv/biomass_strata/DT/strata_biodt2014.csv') #2014

dt2016<- getRvcData(2016, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
strata_biodt2016 <- getStratumBiomass(dt2016, species = dt2016$taxonomic_data$SPECIES_CD, growth_parameters = dt2016$taxonomic_data, merge_protected = F)  
write_csv(strata_biodt2016, 'big_csv/biomass_strata/DT/strata_biodt2016.csv') #2016
...
cat("bind all csv's\n") #concatenate and print - character string naming the file to print to
d_fk = data_frame()
for (f in list.files('big_csv/biomass_strata/FK', pattern="\\.csv", full.names=T)){
      cat(' ', f,'\n')
      d_f = read_csv(
        f, #path to a file 
        progress=F, #progress: Display a progress bar
...
write_csv(d_fk, 'big_csv/biomass_strata/strata_fk_biomass.csv')


## DT biomass by strata
cat("bind all csv's\n") #concatenate and print - character string naming the file to print to
d_dt = data_frame()
for (f in list.files('big_csv/biomass_strata/DT', pattern="\\.csv", full.names=T)){
      cat(' ', f,'\n')
      d_f_dt = read_csv(
        f, #path to a file 
        progress=F, #progress: Display a progress bar
...
write_csv(d_dt, 'big_csv/biomass_strata/strata_dt_biomass.csv')
```
...
dt1999<- getRvcData(1999, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
psu_biodt1999 <- getPSUBiomass(dt1999, species = dt1999$taxonomic_data$SPECIES_CD, growth_parameters = dt1999$taxonomic_data, merge_protected = F)  
write_csv(psu_biodt1999, 'big_csv/biomass_psu/DT/psu_biodt1999.csv') #1999

dt2000<- getRvcData(2000, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
psu_biodt2000 <- getPSUBiomass(dt2000, species = dt2000$taxonomic_data$SPECIES_CD, growth_parameters = dt2000$taxonomic_data, merge_protected = F)  
write_csv(psu_biodt2000, 'big_csv/biomass_psu/DT/psu_biodt2000.csv') #2000

dt2004<- getRvcData(2004, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
psu_biodt2004 <- getPSUBiomass(dt2004, species = dt2004$taxonomic_data$SPECIES_CD, growth_parameters = dt2004$taxonomic_data, merge_protected = F)  
write_csv(psu_biodt2004, 'big_csv/biomass_psu/DT/psu_biodt2004.csv') #2004

dt2006<- getRvcData(2006, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
psu_biodt2006 <- getPSUBiomass(dt2006, species = dt2006$taxonomic_data$SPECIES_CD, growth_parameters = dt2006$taxonomic_data, merge_protected = F)  
write_csv(psu_biodt2006, 'big_csv/biomass_psu/DT/psu_biodt2006.csv') #2006

dt2008<- getRvcData(2008, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
psu_biodt2008 <- getPSUBiomass(dt2008, species = dt2008$taxonomic_data$SPECIES_CD, growth_parameters = dt2008$taxonomic_data, merge_protected = F)  
write_csv(psu_biodt2008, 'big_csv/biomass_psu/DT/psu_biodt2008.csv') #2008

dt2010<- getRvcData(2010, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
psu_biodt2010 <- getPSUBiomass(dt2010, species = dt2010$taxonomic_data$SPECIES_CD, growth_parameters = dt2010$taxonomic_data, merge_protected = F)  
write_csv(psu_biodt2010, 'big_csv/biomass_psu/DT/psu_biodt2010.csv') #2010

dt2012<- getRvcData(2012, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
psu_biodt2012 <- getPSUBiomass(dt2012, species = dt2012$taxonomic_data$SPECIES_CD, growth_parameters = dt2012$taxonomic_data, merge_protected = F)  
write_csv(psu_biodt2012, 'big_csv/biomass_psu/DT/psu_biodt2012.csv') #2012

dt2014<- getRvcData(2014, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
psu_biodt2014 <- getPSUBiomass(dt2014, species = dt2014$taxonomic_data$SPECIES_CD, growth_parameters = dt2014$taxonomic_data, merge_protected = F)  
write_csv(psu_biodt2014, 'big_csv/biomass_psu/DT/psu_biodt2014.csv') #2014

dt2016<- getRvcData(2016, "DRY TORT", server = 'https://www.sefsc.noaa.gov/rvc_analysis20/')
psu_biodt2016 <- getPSUBiomass(dt2016, species = dt2016$taxonomic_data$SPECIES_CD, growth_parameters = dt2016$taxonomic_data, merge_protected = F)  
write_csv(psu_biodt2016, 'big_csv/biomass_psu/DT/psu_biodt2016.csv') #2016
...
cat("bind all csv's\n") #concatenate and print - character string naming the file to print to
d_dt = data_frame()
for (f in list.files('big_csv/biomass_psu/DT', pattern="\\.csv", full.names=T)){
      cat(' ', f,'\n')
      d_f_dt = read_csv(
        f, #path to a file 
        progress=F, #progress: Display a progress bar
...
write_csv(d_dt, 'big_csv/biomass_psu/psu_dt_biomass.csv')
```
