...
##### If interaction term is non-significant, test main effects with pairwise comparisons; if the interaction term is significant, must test 
...
TukeyHSD(biomass_aov, which = "STRAT") #
