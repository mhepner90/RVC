...
## Should I remove the species that are not identified to species level. Is this skewing my diversity indices? What percent of the abundance data is from species identified to the genius? 
grep("SPE.$", domain_fk_abun$SPECIES_CD, value = T)

totalabun = length(domain_fk_abun$abundance)
