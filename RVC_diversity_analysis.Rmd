...
data = all_matrices_data %>%
  ...
  #do.call(rbind,lapply(list("abundance_sum","biomass_sum","richness","evenness", "simpson","shannon", "functional"),function(j) {
    ...
    #data=na.omit(all_matrices_data[,c("YEAR","LON_DEGREES","LAT_DEGREES","DEPTH","STRAT","PROT","abundance_sum","biomass_sum","evenness","richness","simpson","shannon",  "func.div")])
     #lapply(data[,8:14], function(j) {
