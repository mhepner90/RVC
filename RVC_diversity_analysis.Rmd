...
ggplot(stats_all_matrices_data,aes(x=YEAR,y=shannon_mean, col=STRAT, shape=STRAT))+
    #annotation_custom(grob=inset.map,xmin=19,xmax=22.5,ymin=0,ymax=1.5)+
  geom_line(aes(group=STRAT),lwd=1) +
  geom_point(size=5) +
  scale_color_manual(values=c("grey15","grey25","grey35","grey45","grey55","grey65","grey75"),name="Strata")+
  scale_shape_manual(values=c(15:20,6),name="Strata") +
...
# BY STRAT and YEAR
#abundance 
ggplot(stats_all_matrices_data, aes(x=YEAR, y=abundance_mean, colour=STRAT, group=STRAT)) + geom_point() + 
  geom_line() + 
...
#biomass
ggplot(stats_all_matrices_data, aes(x=YEAR, y=biomass_mean, colour=STRAT, group=STRAT)) + 
  geom_point() + 
  geom_line() + 
  geom_errorbar(aes(ymin=biomass_mean-biomass_se, ymax=biomass_mean+biomass_se), width=.2) +
#ggsave(file=".pdf", path="big_csv/plots") 
  labs(x = "Year", y = "Mean biomass") +
  scale_x_continuous(limits = c(1999, 2016), breaks = c(2000,2002, 2004, 2006, 2008, 2010, 2012, 2014, 2016))

#richness
ggplot(stats_all_matrices_data, aes(x=YEAR, y=richness_mean, colour=STRAT, group=STRAT)) + 
  geom_point() +
  geom_line() + 
...
#simpson
ggplot(stats_all_matrices_data, aes(x=YEAR, y=simpson_mean, colour=STRAT, group=STRAT)) +
  geom_point() +
  geom_line() +
...
# shannon
ggplot(stats_all_matrices_data, aes(x=YEAR, y=shannon_mean, colour=STRAT, group=STRAT)) + 
  geom_point() + 
  geom_line() + 
...
#mean abundance
ggplot(matrices_strat_grouped, aes(x=YEAR, y=abundance_mean, colour=STRAT_GROUPED, group=STRAT_GROUPED)) + 
  geom_point() + 
  geom_line() + 
  geom_errorbar(aes(ymin=abundance_mean-abundance_se, ymax=abundance_mean+abundance_se), width=.2)
...
#mean biomass
ggplot(matrices_strat_grouped, aes(x=YEAR, y=biomass_mean, colour=STRAT_GROUPED, group=STRAT_GROUPED)) + 
  geom_point() + 
  geom_line() + 
  geom_errorbar(aes(ymin=biomass_mean-biomass_se, ymax=biomass_mean+biomass_se), width=.2)
#ggsave(file="", path="big_csv/plots")
...
#mean richness
ggplot(matrices_strat_grouped, aes(x=YEAR, y=richness_mean, colour=STRAT_GROUPED, group=STRAT_GROUPED)) + 
  geom_point() + 
  geom_line() + 
  geom_errorbar(aes(ymin=richness_mean-richness_se, ymax=richness_mean+richness_se), width=.2)
#ggsave(file=".pdf", path="big_csv/plots")
...
#mean simpson
ggplot(matrices_strat_grouped, aes(x=YEAR, y=simpson_mean, colour=STRAT_GROUPED, group=STRAT_GROUPED)) + 
  geom_point() + 
  geom_line() + 
  geom_errorbar(aes(ymin=simpson_mean-simpson_se, ymax=simpson_mean+simpson_se), width=.2)
#ggsave(file=".pdf", path="big_csv/plots")
...
#mean shannon
ggplot(matrices_strat_grouped, aes(x=YEAR, y=shannon_mean, colour=STRAT_GROUPED, group=STRAT_GROUPED)) + 
  geom_point() + 
  geom_line() + 
  geom_errorbar(aes(ymin=shannon_mean-shannon_se, ymax=shannon_mean+shannon_se), width=.2)
#ggsave(file=".pdf", path="big_csv/plots")
