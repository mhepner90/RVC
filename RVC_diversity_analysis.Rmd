...
domain_fk_abun <- read_csv('C:/Users/Megan Hepner/Dropbox/github_csv_files/RVC_project/abundance_domain/domain_fk_abun.csv', 
col_types = cols(
  YEAR = col_integer(),
...
domain_fk_abun_diversity = fk_domain_abun_diversity %>%
  select(YEAR, protected_status, dom_richness, dom_simpson, dom_shannon) 

write_csv(domain_fk_abun_diversity, 'abundance_domain/domain_fk_abun_diversity.csv')
...
ggplot(data = fk_domain_abun_diversity, aes(x = YEAR)) +
...
domain_dt_abun <- read_csv('C:/Users/Megan Hepner/Dropbox/github_csv_files/RVC_project/abundance_domain/domain_dt_abun.csv', 
col_types = cols(
  YEAR = col_integer(),
  REGION = col_character(),
  SPECIES_CD = col_character(),
...
strata_fk_abun <- read_csv("C:/Users/Megan Hepner/Dropbox/github_csv_files/RVC_project/abundance_strata/strata_fk_abun.csv",
col_types = cols(
  YEAR = col_integer(),
  REGION = col_character(),
  SPECIES_CD = col_character(),
...
strata_dt_abun <- read_csv("C:/Users/Megan Hepner/Dropbox/github_csv_files/RVC_project/abundance_strata/strata_dt_abun.csv",
col_types = cols(
  YEAR = col_integer(),
  REGION = col_character(),
  SPECIES_CD = col_character(),
...
psu_fk_abun <- read_csv("C:/Users/Megan Hepner/Dropbox/github_csv_files/RVC_project/abundance_psu/psu_fk_abun.csv",
col_types = cols(
  YEAR = col_integer(),
  REGION = col_character(),
  STRAT = col_character(),
...
dt_psu_abun <- read_csv("C:/Users/Megan Hepner/Dropbox/github_csv_files/RVC_project/abundance_psu/psu_dt_abun.csv",
col_types = cols(
  YEAR = col_integer(),
  REGION = col_character(),
  STRAT = col_character(),
...
domain_fk_density <- read_csv("C:/Users/Megan Hepner/Dropbox/github_csv_files/RVC_project/density_domain/domain_fk_density.csv", 
col_types = cols(
  YEAR = col_integer(),
  REGION = col_character(),
  SPECIES_CD = col_character(),
...
domain_dt_density <- read_csv("C:/Users/Megan Hepner/Dropbox/github_csv_files/RVC_project/domain_dt_density.csv", 
col_types = cols(
  YEAR = col_integer(),
  REGION = col_character(),
  SPECIES_CD = col_character(),
...
strata_fkdensity_1999_2016 <- read_csv("C:/Users/Megan Hepner/Dropbox/github_csv_files/RVC_project/density_strata/strata_fkdensity_1999_2016.csv",
col_types = cols(
  YEAR = col_integer(),
  REGION = col_character(),
  SPECIES_CD = col_character(),
...
strata_dtdensity_1999_2016 <- read_csv("C:/Users/Megan Hepner/Dropbox/github_csv_files/RVC_project/density_strata/strata_dtdensity_1999_2016.csv",
col_types = cols(
  YEAR = col_integer(),
  REGION = col_character(),
  SPECIES_CD = col_character(),
...
psu_fkdensity_1999_2016 <- read_csv("C:/Users/Megan Hepner/Dropbox/github_csv_files/RVC_project/density_psu/psu_fkdensity_1999_2016.csv",
col_types = cols(
  YEAR = col_integer(),
  REGION = col_character(),
  SPECIES_CD = col_character(),
...
psu_dtdensity_1999_2016 <- read_csv("C:/Users/Megan Hepner/Dropbox/github_csv_files/RVC_project/density_psu/psu_dtdensity_1999_2016.csv",
col_types = cols(
  YEAR = col_integer(),
  REGION = col_character(),
  SPECIES_CD = col_character(),
