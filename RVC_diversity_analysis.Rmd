...
- MONTH 
- DAY 
- STATION_NR: secondary sampling unit - 7.5m)
...
#write.csv(fk1999_to_2016, file = "FK1999_2016.csv") #saved in Dropbox/github/RVC - Error in data.frame(sample_data = list(PRIMARY_SAMPLE_UNIT = c(1L, 1L,  : arguments imply differing number of rows: 4420893, 206, 402
...
write_csv(abun1999, abun1999.csv) #save domain abundance as csv 

abun_1999_tbl = abun1999 %>%
