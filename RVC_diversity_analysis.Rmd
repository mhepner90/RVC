...
partial_deviance_list = rbind(abun_prop.deviance, bio_prop.deviance,even_prop.deviance, even_prop.deviance, richness_prop.deviance, simp_prop.deviance, shan_prop.deviance, func_prop.deviance)
...
ggsave(file="partial_deviance_explained.pdf", partial_deviance_explained, width=8.5, height=11, path="big_csv/plots")
