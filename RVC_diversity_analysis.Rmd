...
psu_diversity_variables = read_csv("big_csv/bind_psu_variables.csv")
# Parsed with column specification:
# cols(
#   YEAR.x = col_integer(),
#   PRIMARY_SAMPLE_UNIT = col_character(),
#   LAT_DEGREES = col_double(),
#   LON_DEGREES = col_double(),
#   HABITAT_CD = col_character(),
#   ZONE_NR = col_integer(),
#   MPA_NR = col_integer(),
#   STRAT = col_character(),
#   YEAR.y = col_integer(),
...
summary(strata_diversity$simpson)
#  Min.    1st Qu.  Median    Mean    3rd Qu.    Max. 
#  1.670   9.751    12.787    12.227  14.962     19.871  
...
bind_psu_variables = left_join(sample_data, psu_diversity, by="PRIMARY_SAMPLE_UNIT")
