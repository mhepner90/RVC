...
write_csv(psu_fk_abun_no_spp_merged, "big_csv/biomass_psu/psu_fk_abundance_no_spp_merged.csv")
...
# (optional) the psu_bio_sum_YEAR_subset dataframe produced with the code below has years with low sample sizes (few PSUs)/missing strata removed (i.e., 1999, 2000, and 2004)
...
# 1. Read in data and remove years (optional)
psu_abun <- read_csv('big_csv/abundance_psu/psu_fk_abun_no_spp_merged.csv', 
                       col_types = cols(
                          YEAR = col_integer(),
                          REGION = col_character(),
                          STRAT = col_character(),
...
### tried these for abundance (didn't look good for biomass)
