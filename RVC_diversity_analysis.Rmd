...
fk_psu_abun_diversity_no_spp = psu_fk_abun_no_spp %>% #3,134,710 × 10
...
psu_fk_abun_diversity_no_spp = fk_psu_abun_diversity_no_spp %>%
  select(YEAR, PRIMARY_SAMPLE_UNIT, STRAT, protected_status, psu_richness, psu_simpson, psu_shannon) %>% 
unnest(psu_richness,psu_simpson, psu_shannon) %>% 
...
```{r normality and homoscedasticity}
